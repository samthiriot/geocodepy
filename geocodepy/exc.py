"""
Exceptions raised by geocodepy.
"""


class GeopyError(Exception):
    """
    Geopy-specific exceptions are all inherited from geocodepyError.
    """
...
class GeocoderServiceError(GeopyError):
    ...
    and no more specific exception could be raised by geocodepy. When calling
