...
from geocodepy.exc import ConfigurationError, GeocoderQueryError
from geocodepy.geocoders.base import _DEFAULT_USER_AGENT, DEFAULT_SENTINEL, Geocoder
...
class Nominatim(Geocoder):
    ...
    .. attention::
       ...
       ``geocodepy.geocoders.options.default_user_agent = "my-application"``.
    ...
    def geocode(
        ...
        :param str geometry: If present, specifies whether the geocoding
            ...
            `raw` attribute on the returned :class:`geocodepy.location.Location`
            object.
        ...
        :type viewbox: list or tuple of 2 items of :class:`geocodepy.point.Point` or
