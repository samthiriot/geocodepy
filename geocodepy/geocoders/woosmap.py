...
from geocodepy.exc import GeocoderQueryError, GeocoderServiceError, GeocoderUnavailable
...
class Woosmap(Geocoder):
    ...
    def geocode(
        ...
        *,
        ...
        :type location: :class:`geocodepy.point.Point`, list or tuple of ``(latitude,
