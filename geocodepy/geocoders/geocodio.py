...
from geocodepy.exc import GeocoderQueryError, GeocoderQuotaExceeded
from geocodepy.geocoders.base import DEFAULT_SENTINEL, NONE_RESULT, Geocoder
...
class Geocodio(Geocoder):
    ...
    def _geocoder_exception_handler(self, error):
        ...
        in :const:`~geocodepy.geocoders.base.ERROR_CODE_MAP`. The service also returns a
        ``403`` status code for exceeded quotas instead of the ``429`` code mapped in
        :const:`~geocodepy.geocoders.base.ERROR_CODE_MAP`
        """
