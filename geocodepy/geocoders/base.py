...
class options:
    ...
    Example for overriding default ``timeout`` and ``user_agent``::
        ...
        >>> geocodepy.geocoders.options.default_user_agent = 'my_app/1'
        >>> geocodepy.geocoders.options.default_timeout = 7
    ...
    Attributes:
        default_adapter_factory
            A callable which returns a :class:`geocodepy.adapters.BaseAdapter`
            instance. Adapters are different implementations of HTTP clients.
            See :mod:`geocodepy.adapters` for more info.
            ...
            Example::
                ...
                import geocodepy.geocoders
                geocodepy.geocoders.options.default_adapter_factory \
= geocodepy.adapters.URLLibAdapter
            ...
            :class:`geocodepy.adapters.RequestsAdapter`. Otherwise it is
            :class:`geocodepy.adapters.URLLibAdapter`.
        ...
        default_ssl_context
            ...
            To use the CA bundle used by `requests` library::
                ...
                geocodepy.geocoders.options.default_ssl_context = ctx
        ...
        default_timeout
            ...
            before raising a :class:`geocodepy.exc.GeocoderTimedOut` exception.
