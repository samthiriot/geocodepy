...
from geocodepy.timezone import ensure_pytz_is_installed, from_timezone_name
...
class GoogleV3(Geocoder):
    ...
    def __init__(
        ...
        :param str api_key: The API key required by Google to perform
            ...
            .. versionchanged:: 2.1
               ...
               nor premier were specified. Now a :class:`geocodepy.exc.ConfigurationError`
               is raised.
    ...
    def geocode(
        ...
        :type bounds: list or tuple of 2 items of :class:`geocodepy.point.Point` or
    ...
    def reverse_timezone(self, query, *, at_time=None, timeout=DEFAULT_SENTINEL):
        ...
        :rtype: ``None`` or :class:`geocodepy.timezone.Timezone`.
        """
