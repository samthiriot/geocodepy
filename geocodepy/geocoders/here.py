...
from geocodepy.adapters import AdapterHTTPError
...
from geocodepy.geocoders.base import DEFAULT_SENTINEL, ERROR_CODE_MAP, Geocoder
from geocodepy.location import Location
from geocodepy.util import join_filter, logger
...
class Here(Geocoder):
    ...
    def geocode(
        ...
        :type bbox: list or tuple of 2 items of :class:`geocodepy.point.Point` or
        ...
        :param mapview: The app's viewport, given as two coordinate pairs, specified
            ...
            Example: ``[Point(22, 180), Point(-22, -180)]``.
        :type mapview: list or tuple of 2 items of :class:`geocodepy.point.Point` or
            ``(latitude, longitude)`` or ``"%(latitude)s, %(longitude)s"``.
...
class HereV7(Geocoder):
    ...
    def geocode(
        ...
        *,
        ...
        :type at: :class:`geocodepy.point.Point`, list or tuple of ``(latitude,
            longitude)``, or string as ``"%(latitude)s, %(longitude)s"``.
