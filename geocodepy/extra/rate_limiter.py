...
:class:`geocodepy.exc.GeocoderServiceError` exceptions will be retried
(up to ``max_retries`` times)::
    ...
    from geocodepy.extra.rate_limiter import RateLimiter
...
from geocodepy.exc import GeocoderServiceError
...
class RateLimiter(BaseRateLimiter):
    ...
    (like geocoders with the default :class:`geocodepy.adapters.BaseSyncAdapter`).
    ...
    def __init__(
        ...
        *,
        ...
        :param int max_retries:
            ...
            :class:`geocodepy.exc.GeocoderServiceError` exceptions are
...
class AsyncRateLimiter(BaseRateLimiter):
    ...
    (like geocoders with :class:`geocodepy.adapters.BaseAsyncAdapter`).

    Examples::

        from geocodepy.adapters import AioHTTPAdapter
        from geocodepy.extra.rate_limiter import AsyncRateLimiter
        from geocodepy.geocoders import Nominatim
